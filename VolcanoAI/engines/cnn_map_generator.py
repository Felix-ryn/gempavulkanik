...
class CNNMapGenerator:
    def __init__(self, output_dir: str):
        ...
        self.map_path = self.output_dir / "cnn_prediction_map.html"
    ...
    def generate(self, json_path: str):
        ...
        bearing = float(nxt.get("direction_deg", 0))
        distance = float(nxt.get("distance_km", 0))
        confidence = float(nxt.get("confidence", 0))
        ...
        logger.info(f"CNNMapGenerator: map saved -> {self.map_path}")
